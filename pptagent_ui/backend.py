...
RUNS_DIR = package_join("/Users/apple/Desktop/projectPPT/PPTAgent/runs")
STAGES = [
    "PPT Parsing",
    "PDF Parsing",
    "PPT Analysis",
...
async def create_task(
    ...
    task = {
        ...
        "pptx": "/Users/apple/Desktop/projectPPT/PPTAgent/runs/pptx/7cd2a3afeece1a86c1c9b1b8ca362a29",
    }
...
@traceable(name="PPT Generation Task")
async def ppt_gen(task_id: str, rerun=False):
    ...
    try:
        ...
        # pdf parsings
        md_path = join(parsedpdf_dir, "source.md")
        ...
        if not os.path.exists(md_path):
          raise FileNotFoundError(f"source.md not found in {parsedpdf_dir}")
